...
class ActiveSupport::TestCase
  ...
  def setup
    WebMock.disable_net_connect! allow: ['codeclimate.com', /^http:\/\/test\./, /meedan/, 'thisisnotonline.com', 'www.google.com', 'graph.facebook.com',
                                         'twitter.com', 'docs.google.com', 'spreadsheets.google.com', 'accounts.google.com', 'www.googleapis.com', 'api.twitter.com']
